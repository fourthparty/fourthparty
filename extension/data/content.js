...
if(typeof window.navigator.instrumented == "undefined") {
	...
	*/
	...
	function instrumentObjectPropertyAsObject(object, objectName, property, propertyName) {
		...
		//Object.defineProperty(object, propertyName, {value : makeObjectProxyHandler(objectName + "." + propertyName});
		// TODO: rework existing makeObjectProxyHandler.
/*
		Object.defineProperty(object, propertyName, {get : function(){ return bValue; },
